...
public class CategoryVitaminAdapter extends RecyclerView.Adapter<CategoryVitaminAdapter.ViewHolder> {
    private ArrayList<DrugDomain> popularDrug;
    private Context context;

    public CategoryVitaminAdapter(ArrayList<DrugDomain> popularDrug, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_category_vitamin, parent, false);
