...
public class Cat_PainAdapter extends RecyclerView.Adapter<Cat_PainAdapter.ViewHolder> {
    private ArrayList<DrugDomain> popularDrug;
    private Context context;

    public Cat_PainAdapter(ArrayList<DrugDomain> popularDrug, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_pain, parent, false);
