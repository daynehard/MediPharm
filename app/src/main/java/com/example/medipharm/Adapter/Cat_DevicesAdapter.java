...
public class Cat_DevicesAdapter extends RecyclerView.Adapter<Cat_DevicesAdapter.ViewHolder> {
    private ArrayList<DrugDomain> popularDrug;
    private Context context;

    public Cat_DevicesAdapter(ArrayList<DrugDomain> popularDrug, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_devices, parent, false);
