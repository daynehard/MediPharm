...
public class Cat_VaccinesAdapter extends RecyclerView.Adapter<Cat_VaccinesAdapter.ViewHolder> {
    private ArrayList<DrugDomain> popularDrug;
    private Context context;

    public Cat_VaccinesAdapter(ArrayList<DrugDomain> popularDrug, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_vaccine, parent, false);
