...
import com.example.medipharm.Adapter.Cat_SyrupAdapter;
import com.example.medipharm.Adapter.CategoryVitaminAdapter;
...
public class SyrupsFragment extends AppCompatActivity {

    private RecyclerView recyclerViewSyrupList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_syrups_fragment);

        recyclerViewSyrup();
        btnback = findViewById(R.id.back_syrup);
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SyrupsFragment.this, ShowCategory.class));
            }
        });
    }
    private void recyclerViewSyrup(){
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerViewSyrupList = findViewById(R.id.rec_syrup);
        recyclerViewSyrupList.setLayoutManager(gridLayoutManager);
        ...
        adapter3 = new Cat_SyrupAdapter(druglist, this);
        recyclerViewSyrupList.setAdapter(adapter3);
