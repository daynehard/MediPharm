...
import com.example.medipharm.Adapter.Cat_PainAdapter;;
import com.example.medipharm.Domain.DrugDomain;
import com.example.medipharm.R;

import java.util.ArrayList;

public class PainReliefFragment extends AppCompatActivity {

    private RecyclerView recyclerViewPainList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pain_relief_fragment);

        recyclerViewPain();
        btnback = findViewById(R.id.back_pain);
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PainReliefFragment.this, ShowCategory.class));
            }
        });
    }
    private void recyclerViewPain(){
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerViewPainList = findViewById(R.id.rec_pain);
        recyclerViewPainList.setLayoutManager(gridLayoutManager);
        ...
        adapter3 = new Cat_PainAdapter(druglist, this);
        recyclerViewPainList.setAdapter(adapter3);
