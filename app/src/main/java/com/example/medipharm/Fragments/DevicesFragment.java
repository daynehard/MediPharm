...
import com.example.medipharm.Adapter.Cat_DevicesAdapter;
...
public class DevicesFragment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devices_fragment);

        recyclerViewDevices();
        btnback = findViewById(R.id.back_device);
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DevicesFragment.this, ShowCategory.class));
            }
        });
    }
    private void recyclerViewDevices(){
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerViewDevicesList = findViewById(R.id.rec_device);
        recyclerViewDevicesList.setLayoutManager(gridLayoutManager);
        ...
        adapter3 = new Cat_DevicesAdapter(druglist, this);
        recyclerViewDevicesList.setAdapter(adapter3);
