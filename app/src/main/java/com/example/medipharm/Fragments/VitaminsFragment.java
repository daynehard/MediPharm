...
public class VitaminsFragment extends AppCompatActivity {

    private RecyclerView recyclerViewVitaminsList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vitamins_fragment);

        recyclerViewVitamins();
        btnback = findViewById(R.id.back_vits);
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(VitaminsFragment.this, ShowCategory.class));
            }
        });
    }
    private void recyclerViewVitamins(){
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 2);
        recyclerViewVitaminsList = findViewById(R.id.rec_vitamins);
        recyclerViewVitaminsList.setLayoutManager(gridLayoutManager);
        ...
        adapter3 = new CategoryVitaminAdapter(druglist, this);
        recyclerViewVitaminsList.setAdapter(adapter3);
